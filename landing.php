...
<body>
  ...
  style="background-image: url('imgs/landingbg.jpg');background-size: cover;background-attachment: fixed;">
        <div class="mask d-flex align-items-center h-100 backgroundable">
        <div class="container h-100">
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="">
            <p class= "helloworld">    ZAPOČNITE VAŠE PUTOVANJE IZ SNOVA    </p>
            <p class="hookthem">Zaplovite sa nama riznicom najatraktivnijih svetskih destinacija već od danas</p>
            <form action="" method="post" style="text-align:center">
            <button type="submit" class="btn btn-dark btn-lg prikaz ">Prikaži</button>
